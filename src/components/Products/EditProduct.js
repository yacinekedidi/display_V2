        ...
        >
          ...
          <div className="flex  w-full flex-shrink-0 flex-col gap-8 md:w-1/2">
            ...
            <div className="">
              ...
              {imageUrls.map((url, idx) => (
                <div
                  className="flex items-center gap-x-2 px-2 font-cairo text-black"
                  style={{
                    background: 'rgba( 255, 255, 255, 0.25 )',
                    boxShadow: '0 8px 32px 0 rgba( 31, 38, 135, 0.37 )',
                    backdropFilter: 'blur( 4px )',
                  ...
                  key={url}
                >
                  <span className="text-xl text-orange-600">{idx + 1}</span>
                  <p className="w-full overflow-hidden  p-2">{url}</p>
                  <HighlightOffIcon
                    className="cursor-pointer text-orange-600 hover:text-orange-300"
                    onClick={(e) => {
                      setImageUrls((prev) =>
                        imageUrls.filter((u) => u !== url)
                      );
